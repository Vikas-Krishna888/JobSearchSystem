  ...
  return (
    ...
    <div className="loginn">
     <FormControl>
            ...
            <br />
            <TextField label="Job Title" value={title} onChange={handleFieldTitle} className="form-control" type="text" name="title" id="title" placeholder="title" />
            {titleError && <h6 style={{color: 'red'}}>{titleError}</h6>}
            <br/>
            <TextField label="Company Name" value={company} onChange={handleFieldName} className="form-control" type="text" name="company" id="company" placeholder="company" />
